...
public class EnchantedBookItemRenderer extends ItemRenderer {
  private final ItemModelMesher mesher;
  public EnchantedBookItemRenderer(TextureManager p_i46552_1_, ModelManager p_i46552_2_, ItemColors p_i46552_3_, ItemModelMesher mesher) {
